...
<br>
<a href="user.php" style="margin-top: 20px; font-family: Arial, Helvetica, sans-serif; display:block; margin-left: 80px; background-color: purple; height: fit-content; width: fit-content; text-decoration: none; color: white; padding: 10px; border-radius: 20px;"><b>VOLTAR</b></a>