          ...
          <form action="processa_rifa.php" method="post" enctype="multipart/form-data">
            <ul>
              ...
              <li>
                ...
                <input required type="text" class="form-control" placeholder="Exemplo: Dia dos Namorados" style="margin-top: 5px" name="descricao">
              </li>
              ...
              <li>
                ...
                <input required type="number" class="form-control" placeholder="Exemplo: 1.99" style="margin-top: 5px" id="preco" name="preco">
              </li>

              <li>
                <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1"><i class="fa-solid fa-lock-open" style="margin-left: -25px; margin-right: 5px"></i>Números Totais</a>
              ...
              <li>
                ...
                <input required type="date" class="form-control" placeholder="Exemplo: 22-07/2022" style="margin-top: 5px" name="data">
              </li>
